...
namespace {
  ...
  public:
    ...
    ModRefResult getModRefInfo(ImmutableCallSite CS1,
                               ImmutableCallSite CS2, IntegrationAttempt* CS1Ctx = 0, IntegrationAttempt* CS2Ctx = 0, bool usePBKnowledge = true) {
...
GlobalsModRef::getModRefInfo(ImmutableCallSite CS,
  ...
  if (Known == NoModRef) {
    ...
    AliasAnalysis::ModRefResult r = ModRefResult(Known & AliasAnalysis::getModRefInfo(CS, P, Size, CSCtx, PCtx, usePBKnowledge));
    DEBUG(dbgs() << "\nAnswer: not NoModRef\n");
    return r;
  }
}
