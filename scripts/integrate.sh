...
opt -load /home/chris/integrator/llvm/Debug+Asserts/lib/IntegratorAnalyses.so -load /home/chris/integrator/llvm/Debug+Asserts/lib/IntegratorTransforms.so -loop-rotate -instcombine -jump-threading -loopsimplify -lcssa -integrator -jump-threading $@
